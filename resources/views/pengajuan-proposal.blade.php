...
<head>
    ...
    <link rel="stylesheet" href="css/tampilan/pengajuanproposal.css">
</head>
<body>
    <!-- Navigation Bar -->
    ...
    <div class="container my-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 text-end">
                <div class="btn-group">
                    <a href="{{ route('form-pengajuan-proposal') }}" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Proposal</a>
